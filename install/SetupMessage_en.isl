...
SelectDirBrowseLabel=To continue, click Next. If you would like to select a different folder, click Browse. If you choose a system folder to install to, such as "C:\Program Files", click Cancel and re-run the file "setup.exe" as administrator.
...
StartFilelugDesktop=Start Filelug
UninstallFilelugDesktop=Uninstall Filelug
